	  ...
	  <div class="panel-body">
	    <table class="table table-striped table-hover ">
		  ...
		  <tbody>
			 ...
			 <td>
			 	<a class="btn btn-warning" href="<?php echo URL; ?>departamentos/editar/<?php echo $row['id']; ?>">Editar</a>
				<a class="btn btn-danger" href="<?php echo URL; ?>departamentos/eliminar/<?php echo $row['id']; ?>">Eliminar</a>
			</td>
			</tr>
			<?php } ?>
		  </tbody>
